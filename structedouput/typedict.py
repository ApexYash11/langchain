...
class review(TypedDict):
  ...
  key_themes: Annotated[list[str], "A list of key themes mentioned in the review in a list"]
  pros: Annotated[list[str], "A list of positive aspects of the product mentioned in the review in a list"]
  cons: Annotated[list[str], "A list of negative aspects of the product mentioned in the review in a list"]
  name: Annotated[str, "The name of the product being reviewed"]
